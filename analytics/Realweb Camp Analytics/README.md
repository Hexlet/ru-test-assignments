...
1. Перед тобой [датасет](Realweb%20summer_camp_data.csv) некой интернет-компании. Загрузи его в Python или R, ознакомься с данными и ответь на приведенные ниже вопросы. Для ответа на некоторые из них
...
1. Готов ли ты, начиная с июня, рассматривать официальное трудоустройство? Выдели
   необходимый вариант:
